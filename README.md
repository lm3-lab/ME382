...
> **A note on LLM usage.** These are meant to be illustrative examples of some key concepts in
> ME382 which will be expanded over time. All code is generated by an LLM under human guidance;
> we provide a human/LLM attribution for each section below.
>
> **The intention, as time allows, is for the amount of LLM text to converge to zero.**
>
> Please email tswin "at" umich.edu with any accuracy concerns!
